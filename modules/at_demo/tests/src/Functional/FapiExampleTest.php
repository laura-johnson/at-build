...
/**
 * Ensure that the at_demo forms work properly.
 *
 * @group at_demo
 * @group examples
 *
...
class FapiExampleTest extends ExamplesBrowserTestBase {
  ...
  public function doTestRoutes() {
    ...
    $routes = [
      'at_demo.description' => [],
      'at_demo.simple_form' => ['Submit'],
      'at_demo.input_demo' => ['Submit'],
      'at_demo.state_demo' => ['Submit'],
      'at_demo.container_demo' => ['Submit'],
      'at_demo.vertical_tabs_demo' => ['Submit'],
      // Modal form has a submit button, but requires input.
      'at_demo.modal_form' => [],
      'at_demo.ajax_color_demo' => ['Submit'],
      'at_demo.build_demo' => ['Submit'],
      'at_demo.ajax_addmore' => ['Submit'],
      // Multistep form has submit buttons, but requires input.
      'at_demo.multistep_form' => [],
    ];
  ...
  public function doTestAjaxColorForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.ajax_color_demo'), $edit, 'Submit');
  ...
  public function doTestBuildDemo() {
    $assert = $this->assertSession();
    $build_demo_url = Url::fromRoute('at_demo.build_demo');
  ...
  public function doTestContainerDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.container_demo'), $edit, 'Submit');
  ...
  public function doTestInputDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.input_demo'), $edit, 'Submit');
    $assert->statusCodeEquals(200);
  ...
  public function doTestModalForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.modal_form'), $edit, 'Submit');
    $assert->pageTextContains('Submit handler: You specified a title of My Book.');
  }

  /**
   * Check routes defined by at_demo.
   */
  public function doTestSimpleFormExample() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.simple_form'), $edit, 'Submit');
  ...
  public function doTestStateDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('at_demo.state_demo'), $edit, 'Submit');
  ...
  public function doTestAjaxAddMore() {
    ...
    $ajax_addmore_url = Url::fromRoute('at_demo.ajax_addmore');
